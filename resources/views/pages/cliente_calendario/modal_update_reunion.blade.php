<div class="modal fade" id="updt_reunion" tabindex="-1" data-contacto="{{ @old('contactoId') }}" role="dialog" aria-labelledby="updateComunicacionModalLabel" aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="date" id="updt_fechaReunion" name="fechaReunion" class="form-control @error('fechaReunion') is-invalid @enderror" value="{{ @old('fechaReunion') }}">
