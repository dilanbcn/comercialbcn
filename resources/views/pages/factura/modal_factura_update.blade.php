                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="date" id="fechaFacturacion" name="fechaFacturacion" class="form-control @error('fechaFacturacion') is-invalid @enderror fechaFacturacion" value="{{ @old('fechaFacturacion') }}" max="{{ date('Y-m-d') }}" required>
                                ...
                                <!--<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="date" id="fechaPago" name="fechaPago" class="form-control @error('fechaPago') is-invalid @enderror fechaPago" value="{{ @old('fechaPago') }}" max="{{ date('Y-m-d') }}" required>
