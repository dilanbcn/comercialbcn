<div class="modal fade" id="modal_update_cliente_contacto" tabindex="-1" role="dialog" aria-labelledby="contactoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="form-prevent-multiple-submits frm_modal_update" action="" id="frm_update_cliente_contacto" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" type="number" id="telefono" name="telefono" class="form-control @error('telefono') is-invalid @enderror telefono" value="{{ @old('telefono') }}" required>
