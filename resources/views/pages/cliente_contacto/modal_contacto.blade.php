<div class="modal fade" id="add_contacto_cliente" tabindex="-1" role="dialog" aria-labelledby="proyectosModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form class="form-prevent-multiple-submits" action="{{ route('cliente-contacto.store', [$cliente->id]) }}" id="frm_add_proyectos" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{ __('Fono Fijo') }} <span class="text-required">*</span></label>
                                        <input autocomplete="off" type="number" placeholder="2XXXXXXXX" name="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ @old('telefono') }}" required>
