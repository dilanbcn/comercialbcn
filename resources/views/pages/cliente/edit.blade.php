                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('comercialDestino') is-invalid @enderror" id="comercialDestino" name="comercialDestino">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>{{ __('Comercial Origen') }} </label>
                                    <select class="form-control @error('comercial') is-invalid @enderror" id="comercial" name="comercial" disabled>
                                        @foreach ($usuarios as $usuario)
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" type="date" name="inicio_relacion" class="form-control @error('inicio_relacion') is-invalid @enderror inicio_relacion" value="{{ (@old('inicio_relacion')) ? @old('inicio_relacion') : ( $cliente->inicio_relacion ? date('Y-m-d', strtotime($cliente->inicio_relacion)) : '' )       }}" max="{{ date('Y-m-d', strtotime($hoy)) }}">
