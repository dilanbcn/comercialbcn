                    ...
                    <table border="0" style="width: 600px;">
                        <tr>
                            <td>
                                ...
                                <p style="text-align: justify;">Se ha agendado una nueva reunión</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <table style="width: 100%;" id="tableReunion">
                                    ...
                                    <tr>
                                        <td style="font-weight: bold; text-align: left;">FECHA REUNIÓN</td>
                                        <td style="text-align: left;">{{ date('d/m/Y', strtotime($comunicacion->fecha_reunion)) }}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bold; text-align: left;">HORA REUNIÓN</td>
